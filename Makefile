...
gera-remote: pdf gera-html
	rsync --delete -av $(NAME)/* genoslab-handbook.pdf src /srv/http/genos.mus.br/handbook/

envia: gera-html pdf
	rsync --delete -av genoslab-handbook.html_dir/* genoslab-handbook.pdf genos.mus.br:/srv/http/genos.mus.br/handbook/
