...
\chapter{Ferramentas on-line do genos}
\label{cha:ferramentas-line-do}

\chapter{Editando o wiki do genos}
\label{cha:editando-o-wiki}
...
\url{modelo-ppgmus-completo.tex} mostra como usar todas as opções
disponíveis. O resultado de \url{modelo-ppgmus-completo.tex} pode ser
visto em \url{modelo-ppgmus-completo.pdf}.
