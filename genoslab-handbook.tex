...
\author{Pedro Kröger e Marcos di Silva}
...
Lilypond é um software para criar partituras musicais para
impressão. É um software livre e é compatível com plataformas Linux,
Windows e Mac. O portal do software é bastante completo:
\url{lilypond.org}

\section{Abstração de comandos em variáveis}
...
\section{Usando variáveis em partituras com vários instrumentos}
...
violoncelo. Então inserimos $\backslash$viola e $\backslash$violoncelo
em partitura.ly e definimos essas variáveis nos arquivos viola.ly e
violoncelo.ly
